...
//to make the size work on phone and desktop
...
let d = document.querySelector('.dot');
let la = document.querySelector('.leftArrow');
let ra = document.querySelector('.rightArrow');

if (w <= 1080 && h <= 1920 ) {
document.getElementById('projectOneLinkTop').style.backgroundColor = 'red';
...
function projectTwo() {
	document.body.h2.innerHTML = 'Story Writing App';
